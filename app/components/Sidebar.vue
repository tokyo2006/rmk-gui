...
<template>
  <div class="flex flex-col items-center bg-base-100 min-w-48 border-r border-base-300">
    ...
    <!-- items -->
    <label v-for="item in items" class="outline outline-2 hover:bg-base-200 outline-base-100 rounded-lg mt-3 cursor-pointer" :class="{ 'outline-primary': selectedPage == item.value }">
