...
<template>
  <div class="bg-base-100 w-48 border-r border-base-300">
    ...
    <label class="custom-option py-3 flex w-36 mx-auto mt-2 border-base-100">
      ...
      <div class="flex justify-center items-center w-full">
        ...
        <span class="w-15 font-bold"> Macro </span>
      </div>
    </label>
    <label class="custom-option py-3 flex w-36 mx-auto mt-2 border-base-100">
      ...
      <div class="flex justify-center items-center w-full">
        ...
        <span class="w-15 font-bold"> OTA </span>
      </div>
    </label>
    <label class="custom-option py-3 flex w-36 mx-auto mt-2 border-base-100">
      ...
      <div class="flex justify-center items-center w-full">
        ...
        <span class="w-15 font-bold"> Setting </span>
      </div>
    </label>
  </div>
</template>
