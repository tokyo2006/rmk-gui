...
<template>
  <label
    class="flex justify-center items-center bg-base-100 h-10 min-w-10 rounded-md border shadow-sm px-1 cursor-pointer"
    :class="{ 'border-primary': selectedValue === props.lower }"
  ...
  >
    ...
    <span
      ...
      :class="{ 'text-[10px]': lower.length > 1 }"
      :style="{ width: spanWidth }"
    >
      {{ lower }}
    </span>
